...
internal sealed record MinerUBatchUrlRequest(
    ...
    string Language,
    [property: JsonPropertyName("enable_table")]
    bool EnableTable,
    [property: JsonPropertyName("enable_formula")]
    bool EnableFormula);
...
internal sealed record MinerUBatchUrlFile(
    ...
    [property: JsonPropertyName("data_id")]
    string DataId);
...
internal sealed record MinerUBatchUrlData(
    ...
    string? BatchId,
    [property: JsonPropertyName("file_urls")]
...
internal sealed record MinerUPollData(
    ...
    [property: JsonPropertyName("full_zip_url")]
    string? FullZipUrl,
    [property: JsonPropertyName("err_msg")]
    string? ErrorMessage,
    [property: JsonPropertyName("extract_result")]
    IReadOnlyList<MinerUPollExtractResultItem>? ExtractResult);
