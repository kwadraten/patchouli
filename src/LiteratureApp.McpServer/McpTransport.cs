...
namespace LiteratureApp.McpServer;
...
public sealed class McpProtocolHandler
{
    ...
    public async Task<string> HandleAsync(string line, CancellationToken ct = default)
    {
        try
        {
            ...
            {
                "initialize" => new { protocolVersion = "2024-11-05", serverInfo = new { name = "LiteratureApp", version = LiteratureApp.Core.BuildInfo.Version }, capabilities = new { tools = new { } } },
