// <auto-generated />
// Generated by tools/palette-generator/generate_palettes.py from @radix-ui/colors 3.0.0.
...
public static partial class UiColorPalettes
{
    ...
    private static readonly (string Id, string Name, string Gray, string Accent, bool DarkOnPrimary)[]
        RadixPalettes =
        [
            ("radix-gray", "Radix Gray", "gray", "gray", false),
            ("radix-mauve", "Radix Mauve", "mauve", "mauve", false),
            ("radix-slate", "Radix Slate", "slate", "slate", false),
            ("radix-sage", "Radix Sage", "sage", "sage", false),
            ("radix-olive", "Radix Olive", "olive", "olive", false),
            ("radix-sand", "Radix Sand", "sand", "sand", false),
            ("radix-tomato", "Radix Tomato", "mauve", "tomato", false),
            ("radix-red", "Radix Red", "mauve", "red", false),
            ("radix-ruby", "Radix Ruby", "mauve", "ruby", false),
            ("radix-crimson", "Radix Crimson", "mauve", "crimson", false),
            ...
            ("radix-cyan", "Radix Cyan", "slate", "cyan", false),
            ("radix-teal", "Radix Teal", "sage", "teal", false),
            ("radix-jade", "Radix Jade", "sage", "jade", false),
            ("radix-green", "Radix Green", "sage", "green", false),
            ("radix-grass", "Radix Grass", "olive", "grass", false),
            ("radix-brown", "Radix Brown", "sand", "brown", false),
            ("radix-orange", "Radix Orange", "sand", "orange", false),
            ("radix-sky", "Radix Sky", "slate", "sky", true),
            ("radix-mint", "Radix Mint", "sage", "mint", true),
            ("radix-lime", "Radix Lime", "olive", "lime", true),
            ("radix-yellow", "Radix Yellow", "sand", "yellow", true),
            ("radix-amber", "Radix Amber", "sand", "amber", true),
            ("radix-gold", "Radix Gold", "sand", "gold", false),
            ("radix-bronze", "Radix Bronze", "sand", "bronze", false),
        ];
}
