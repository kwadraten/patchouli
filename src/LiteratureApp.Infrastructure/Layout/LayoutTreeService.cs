    ...
    private sealed class LayoutRevisionRow
    {
        ...
        public LayoutRevision ToRevision()
        {
            return new LayoutRevision(
                LiteratureApp.Core.Ids.LayoutRevisionId.Parse(LayoutRevisionId),
                LiteratureApp.Core.Ids.DocumentInstanceId.Parse(DocumentInstanceId),
                ParentRevisionId is null ? null : LiteratureApp.Core.Ids.LayoutRevisionId.Parse(ParentRevisionId),
                Source,
                IsCurrent == 1,
    ...
    private sealed class LayoutNodeRow
    {
        ...
        public LayoutNode ToNode()
        {
            return new LayoutNode(
                LiteratureApp.Core.Ids.LayoutNodeId.Parse(NodeId),
                LiteratureApp.Core.Ids.DocumentInstanceId.Parse(DocumentInstanceId),
                LiteratureApp.Core.Ids.PageId.Parse(PageId),
                ParentNodeId is null ? null : LiteratureApp.Core.Ids.LayoutNodeId.Parse(ParentNodeId),
                NodeType,
                ...
                ReadingOrder,
                Source,
                LiteratureApp.Core.Ids.LayoutRevisionId.Parse(RevisionId),
                Confidence,
                Ignored == 1);
        }
    }
