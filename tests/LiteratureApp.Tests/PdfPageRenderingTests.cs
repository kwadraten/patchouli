...
public sealed class PdfPageRenderingTests
{
    ...
    [Fact] public void Product_ui_uses_pdf_preview_placeholder_not_legacy_batch_ocr_copy() => File.ReadAllText(TestPaths.FromRepositoryRoot("src","LiteratureApp.UI","MainWindow.axaml")).Should().Contain("PDF 预览").And.NotContain("batch PDF OCR");
